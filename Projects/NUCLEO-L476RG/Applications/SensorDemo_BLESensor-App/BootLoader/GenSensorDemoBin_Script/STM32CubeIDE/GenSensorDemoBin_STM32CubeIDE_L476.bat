::/**
::  ******************************************************************************
::  * @file    GenSensorDemoBin_STM32CubeIDE_L476.bat
...
::   Example: set APPNAME=..\..\..\STM32CubeIDE\Release\SensorDemo_BLESensor-App
:: NOTE: This script requires a .bin file is generated by the STM32CubeIDE build process.
::       To generate a .bin file, from STM32CubeIDE project, go to "Project -> Properties -> C/C++ Build -> Settings".
::       Then, from "Tool Settings" tab, go to "MCU Post build outputs" and check "Convert to binary file (-O binary)".
set APPNAME=..\..\..\STM32CubeIDE\Release\SensorDemo_BLESensor-App
