::/**
::  ******************************************************************************
::  * @file    GenSensorDemoBin_EWARM_L476.bat
...
::   Example: set APPNAME=..\..\..\EWARM\SensorDemo_BLESensor-App\Exe\SensorDemo_BLESensor-App_L476RG
:: NOTE: This script requires a .bin file is generated by the IAR build process.
::       To generate a .bin file, from IAR project, go to "Project -> Output Converter" and set "Raw binary" as Output format.
set APPNAME=..\..\..\EWARM\SensorDemo_BLESensor-App\Exe\SensorDemo_BLESensor-App_L476RG
